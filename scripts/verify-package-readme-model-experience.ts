...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/connection-desktop': { kind: 'none', reason: 'Browser-side IPC carrier; transports already-composed payloads and registers nothing model-facing.' },
  ...
  'packages/bundle/desktop-app': { kind: 'indirect', reason: 'The bundle selects the base persona and mounts runtime packages that own their model-facing registrations.' },
